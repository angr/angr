...
l = logging.getLogger(name="angr.ddg")

# Data dependence graph
# We track dependencies between registers, stack variables and global
# memory.
...
class DDG(object):
	...
	def construct(self, irsb, stmt_id):
		l.debug("construct ddg from entrypoint 0x%08x" % (self._binary.entry()))
