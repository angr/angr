...
class __libc_start_main(simuvex.SimProcedure):
    ...
    def _initialize_ctype_table(self):
        ...
        for pos, c in enumerate(self.LOCALE_ARRAY):
            self.state.memory.store(table + pos, c, size=1)
        ...
        # TODO: We need a central storage for storing libc-related constants, pointers, etc.
        simuvex.SimProcedures['libc.so.6']['__libc_start_main'].ctype_table_ptr = table_ptr
