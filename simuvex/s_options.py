...
BYPASS_SSE_EXCEPTIONS = 'BYPASS_SSE_EXCEPTIONS'

# Default options for various modes
default_options = { }
resilience_options = { BYPASS_UNSUPPORTED_IROP, BYPASS_UNSUPPORTED_IREXPR, BYPASS_UNSUPPORTED_IRSTMT, BYPASS_UNSUPPORTED_IRDIRTY, BYPASS_UNSUPPORTED_IRCCALL, BYPASS_ERRORED_IRCCALL, BYPASS_UNSUPPORTED_SYSCALL, BYPASS_ERRORED_IROP, BYPASS_SSE_EXCEPTIONS }
refs = { REGISTER_REFS, MEMORY_REFS, TMP_REFS, CODE_REFS, ACTION_DEPS, CONSTRAINT_ACTIONS }
...
default_options['symbolic'] = default_options['symbolic_norefs']
