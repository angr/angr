...
corrupt_addrs = {
    ...
    # all-zero bytes: the old corrupt bytes (primary opcode 1) decode as a prefixed instruction since Valgrind 3.27
    "ppc": [0x100006B8, b"\x00\x00\x00\x00", lambda s: s.registers.store("r5", 8)],
