...
class TestMemory(unittest.TestCase):
    ...
    def test_memory(self):
        ...
        assert set(s.memory.addrs_for_hash(hash(x))) == {0x1000, 0x1001, 0x2000, 0x2001}
        ...
        assert set(s2.memory.addrs_for_hash(hash(x))) == {0x1000, 0x1001}
        assert set(s2.memory.addrs_for_name("ref_test2")) == {0x2000, 0x2001}
        assert set(s2.memory.addrs_for_hash(hash(y))) == {0x2000, 0x2001}
