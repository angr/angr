...
def setup_amd64():
    ...
    strstr_and_strncpy_amd64 = angr.Project(test_location + "/strstr_strncpy/strstr_and_strncpy-amd64", load_libs=True, default_analysis_mode='symbolic', use_sim_procedures=True, exclude_sim_procedures=['strncpy','strstr'])
