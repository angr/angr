...
def test_mips():
    ...
    s = arger_mips.initial_state(argv = ['aaa', "Yan is a noob"], envp ={"HOME": "/home/angr"})
    ...
    s = arger_mips.initial_state(argv = ['aaa', 'Yan is not a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_mips, find=[r_addr], start=arger_mips.exit_to(arger_mips.entry, state=s))
    xpl.run()
...
def test_mipsel():
    ...
    s = arger_mipsel.initial_state(argv = ['aaa', 'Yan is not a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_mipsel, find=[r_addr], start=arger_mipsel.exit_to(arger_mipsel.entry, state=s))
    xpl.run()
...
def test_i386():
    r_addr = 0x80483d4
    s = arger_i386.initial_state(argv = ['aaa', 'Yan is a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_i386, find=[r_addr], start=arger_i386.exit_to(arger_i386.entry, state=s))
    xpl.run()

    nose.tools.assert_equals(len(xpl.found), 1)

    s = arger_i386.initial_state(argv = ['aaa', 'Yan is not a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_i386, find=[r_addr], start=arger_i386.exit_to(arger_i386.entry, state=s))
    xpl.run()
...
def test_amd64():
    ...
    s = arger_amd64.initial_state(argv = ['aaa', 'Yan is not a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_amd64, find=[r_addr], start=arger_amd64.exit_to(arger_amd64.entry, state=s))
    xpl.run()
...
def test_arm():
    ...
    s = arger_arm.initial_state(argv = ['aaa', 'Yan is a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_arm, find=[r_addr], start=arger_arm.exit_to(arger_arm.entry, state=s))
    xpl.run()

    nose.tools.assert_equals(len(xpl.found), 1)

    s = arger_arm.initial_state(argv = ['aaa', 'Yan is not a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_arm, find=[r_addr], start=arger_arm.exit_to(arger_arm.entry, state=s))
    xpl.run()
...
def test_ppc32():
    ...
    s = arger_ppc32.initial_state(argv = ['aaa', 'Yan is a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_ppc32, find=[r_addr], start=arger_ppc32.exit_to(arger_ppc32.entry, state=s))
    xpl.run()

    nose.tools.assert_equals(len(xpl.found), 1)

    s = arger_ppc32.initial_state(argv = ['aaa', 'Yan is not a noob'], envp ={"HOME": "/home/angr"})
    xpl = angr.surveyors.Explorer(arger_ppc32, find=[r_addr], start=arger_ppc32.exit_to(arger_ppc32.entry, state=s))
    xpl.run()
