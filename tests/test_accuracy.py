...
arch_data = {  # (steps, [hit addrs], finished)
    ...
    'i386': (
    425, (0x90198e0, 0x90195c0, 0x9019630, 0x90198a0, 0x8048370, 0x80482f8, 0x8048440, 0x804846D, 0x8048518), True),
...
class TestAccuracy(unittest.TestCase):
    def _emulate(self, arch, binary, use_sim_procs, steps, hit_addrs, finished):
        ...
        state = p.factory.full_init_state(args=['./test_arrays'],
                                          add_options={angr.options.STRICT_PAGE_ACCESS, angr.options.ENABLE_NX,
