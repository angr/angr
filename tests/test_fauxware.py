...
def test_x86():
    fauxware_x86 = angr.Project(test_location + "/i386/fauxware", default_analysis_mode='symbolic', arch="X86")
...
def test_ppc32():
    fauxware_ppc32 = angr.Project(test_location + "/ppc/fauxware", default_analysis_mode='symbolic', arch="PPC32")
...
def test_arm():
    fauxware_arm = angr.Project(test_location + "/armel/fauxware", default_analysis_mode='symbolic', arch=simuvex.SimARM(endness="Iend_LE"))
...
def test_mips():
    fauxware_mips = angr.Project(test_location + "/mips/fauxware", default_analysis_mode='symbolic', arch=simuvex.SimMIPS32(endness="Iend_BE"))
