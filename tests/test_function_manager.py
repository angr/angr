...
def setup_amd64():
    ...
    fauxware_amd64 = angr.Project(test_location + "/build/x86_64/fauxware", load_libs=False, default_analysis_mode='symbolic', use_sim_procedures=True, arch="AMD64")
def setup_ppc32():
...
def setup_mipsel():
    ...
    fauxware_mipsel = angr.Project(test_location + "/build/mipsel/fauxware", load_libs=False, default_analysis_mode='symbolic', use_sim_procedures=True, arch=simuvex.SimMIPS32(endness="Iend_LE"))
def setup_arm():
    global fauxware_arm
    fauxware_arm = angr.Project(test_location + "/build/armhf/fauxware/fauxware-arm", load_libs=False, default_analysis_mode='symbolic', use_sim_procedures=True, arch=simuvex.SimARM(endness="Iend_LE"))
