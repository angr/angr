...
def setup_amd64():
    ...
    strncpy_size_amd64 = angr.Project(test_location + "/build/x86_64/strncpy_size", load_libs=True, default_analysis_mode='symbolic', use_sim_procedures=True, exclude_sim_procedures=['strncpy'])
