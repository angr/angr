...
def test_strncpy():
    strncpy_amd64 = angr.Project(os.path.join(test_location, 'x86_64', 'strncpy'), load_options={'auto_load_libs': True}, exclude_sim_procedures_list=['strncpy'])#auto_load_libs can't be disabled as the test cases failed.
...
def test_strncpy_size():
    strncpy_size_amd64 = angr.Project(os.path.join(test_location, 'x86_64', 'strncpy-size'), load_options={'auto_load_libs': True}, exclude_sim_procedures_list=['strncpy'])#auto_load_libs can't be disabled as the test cases failed.
...
def test_strncpy_verify_null():
    strncpy_verify_null_amd64 = angr.Project(os.path.join(test_location, 'x86_64', 'strncpy-verify-null'), load_options={'auto_load_libs': True}, exclude_sim_procedures_list=['strncpy'])#auto_load_libs can't be disabled as the test cases failed.
...
def test_strstr_and_strncpy():
    strstr_and_strncpy_amd64 = angr.Project(os.path.join(test_location, 'x86_64', 'strstr_and_strncpy'), load_options={'auto_load_libs': True}, exclude_sim_procedures_list=['strstr'])#auto_load_libs can't be disabled as the test cases failed.
...
def test_strstr():
    strstr_amd64 = angr.Project(os.path.join(test_location, 'x86_64', 'strstr'), load_options={'auto_load_libs': True}, exclude_sim_procedures_list=['strstr'])#auto_load_libs can't be disabled as the test cases failed.
