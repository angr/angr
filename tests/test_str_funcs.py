...
def test_strncpy():
    ...
    s = explorer.found[0]
    result = s.se.eval(s.memory.load(s.registers.load(16), 16), cast_to=str)
    nose.tools.assert_equal(result, 'why hello there\x00')
...
def test_strncpy_size():
    ...
    s = explorer.found[0]
    result = s.se.eval(s.memory.load(s.registers.load(16), 40), cast_to=str)
    nose.tools.assert_equal(result, 'just testing things\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
...
def test_strncpy_verify_null():
    ...
    s = explorer.found[0]
    result = s.se.eval(s.memory.load(s.registers.load(16), 40), cast_to=str)
    nose.tools.assert_equal(result, 'just testing things\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00AAAAAA\x00')
...
def test_strstr_and_strncpy():
    ...
    s = explorer.found[0]
    result = s.se.eval(s.memory.load(s.registers.load(16), 15), cast_to=str)
    nose.tools.assert_equal(result, 'hi th hi there\x00')
...
def test_strstr():
    ...
    s = explorer.found[0]
    result = s.se.eval(s.memory.load(s.registers.load(16), 9), cast_to=str)
    nose.tools.assert_equal(result, 'hi there\x00')
