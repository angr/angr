...
class TestUnicorn(unittest.TestCase):
    ...
    def test_similarity_fauxware(self):
        ...
        self._run_similarity(os.path.join("binaries", "tests", "i386", "fauxware"), 1000, prehook=cooldown)

    def test_fp(self):
        with open(os.path.join(test_location, "binaries", "tests_src", "manyfloatsum.c"), encoding="utf-8") as fp:
