...
def setup_amd64():
    global memset_amd64
    memset_amd64 = angr.Project(test_location + "/build/x86_64/memset", load_libs=True, default_analysis_mode='symbolic', use_sim_procedures=True, exclude_sim_procedures=['memset'])
