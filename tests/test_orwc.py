...
def setup_rw():
    global p_rw
    p_rw = angr.Project(test_location + "/build/x86_64/rw", load_libs=False, default_analysis_mode='symbolic', use_sim_procedures=False)

def setup_orwc():
    global p
    p = angr.Project(test_location + "/build/x86_64/orwc", load_libs=False, default_analysis_mode='symbolic', use_sim_procedures=False)
