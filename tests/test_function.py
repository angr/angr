...
def test_function_definition_application():
    ...
    assert func_main.prototype.args == [angr.sim_type.SimTypeInt().with_arch(p.arch), angr.sim_type.SimTypePointer(                                 angr.sim_type.SimTypePointer(angr.sim_type.SimTypeChar()).with_arch(p.arch)).with_arch(p.arch)]
