...
def test_virtual_variable_int_oident():
...
def test_side_effect_statement():
...
def test_block_with_mixed_statements():
    block = Block(
        0x400,
        statements=[
            Label(0, "L1"),
