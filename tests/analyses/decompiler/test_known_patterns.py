...
class TestSwapWidthsAndInterleaving(TestCase):
    ...
    def _decompile_pair_swap():
        ...
        ``data_references=True`` matters: without it calling-convention
        ...
        over-approximation rather than a pattern gap; the finder-level test
        below matches all three either way.
        """
