...
def test_string_cmp_extract_cmp_recognizes_load_eq_const_pattern():
    ...
    # Phase D: operand access mints a fresh Expression wrapper, so legacy
    # ``is`` no longer discriminates "returned the operand verbatim". Use
