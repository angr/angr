...
def _decompile_with_prototype(bin_path: str, func_name: str, arg_types, ret_type):
    ...
    where it comes from an inlined-accessor KnownPattern that fired somewhere in the same function; pinning it makes
    the test independent of which patterns happen to match this fixture.
    """
