...
class TestRustTypeHints(unittest.TestCase):
    def test_rust_type_hints_are_function_scoped(self):
        ...
        try:
            ...
            assert False, "Expected TypeError when adding a type hint without specifying an address"
