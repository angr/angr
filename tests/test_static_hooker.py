...
def test_static_hooker():
    ...
    nose.tools.assert_is(sh.results[4197616], angr.SIM_PROCEDURES['libc.so.6']['__libc_start_main'])
    nose.tools.assert_is(p.hooked_by(4197616).procedure, angr.SIM_PROCEDURES['libc.so.6']['__libc_start_main'])
