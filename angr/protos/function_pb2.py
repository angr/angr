...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FUNCTION']._serialized_end=707
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_start=650
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_end=693
