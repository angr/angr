...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FUNCTION']._serialized_end=601
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_start=558
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_end=601
