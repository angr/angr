...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FUNCTION']._serialized_end=769
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_start=712
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_end=755
