...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FUNCTION']._serialized_end=749
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_start=692
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_end=735
