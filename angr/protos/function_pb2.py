...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FUNCTION']._serialized_end=732
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_start=675
  _globals['_FUNCTION_SIGNATURESOURCE']._serialized_end=718
