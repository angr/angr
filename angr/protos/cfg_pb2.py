...
from protos import primitives_pb2 as protos_dot_primitives__pb2
...
MemoryData = _reflection.GeneratedProtocolMessageType('MemoryData', (_message.Message,), dict(
