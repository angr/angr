...
class FunctionHandler(ABC):
    ...
    @abstractmethod
    def handle_local_function(self, state, function_address, call_stack, maximum_local_call_depth, visited_blocks, codeloc=None):
        """
        ...
        :return Tuple[Boolean,LiveDefinitions,List<ailment.Block|Block|CodeNode|CFGNode>]:
        """
        raise NotImplementedError()
