...
class memcpy(Func):
    ...
    def pre_test(self, func, runner):
        ...
        self.memmove_safe = bool(result_state.se.eval(result_state.memory.load(0x2000, 8), cast_to=bytes) == "ABCABC\x00\x00")
        ...
        result_state = call.result_state
        if result_state.se.eval(result_state.memory.load(0x2000, 8), cast_to=bytes) == "\x00\x00CBACBA":
