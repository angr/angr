...
from angr.ailment.statement import Statement, Assignment, CallStmt, Label
...
class RegVVarPredicate:
    ...
    def _get_call_clobbered_regs(self, stmt: CallStmt) -> set[int]:
        ...
        for block in traversal_order:
            ...
            for stmt_idx, stmt in enumerate(block.statements):
                ...
                if isinstance(stmt, Assignment) and isinstance(stmt.dst, VirtualVariable) and stmt.dst.was_reg:
                    ...
                    isinstance(stmt, CallStmt) and isinstance(stmt.ret_expr, VirtualVariable) and stmt.ret_expr.was_reg
                ):
