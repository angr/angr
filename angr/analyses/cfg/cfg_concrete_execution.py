...
class CFGConcreteExecution(ForwardAnalysis, CFGBase):    # pylint: disable=abstract-method
    """
...
AnalysesHub.register_default('CFGConcreteExecution', CFGConcreteExecution)
