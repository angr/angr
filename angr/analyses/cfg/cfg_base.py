...
# has decided what its entries mean. The one angr has already decided to hold back is a PE's
# exception directory: CFGBase reads those records through their own set and leaves them low
# confidence.
DEFINITE_FUNCTION_HINT_SOURCES = frozenset(
    {FunctionHintSource.EXPORT_TABLE, FunctionHintSource.EXTERNAL_EH_FRAME, FunctionHintSource.MACHO_FUNCTION_STARTS}
)
