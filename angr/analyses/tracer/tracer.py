...
from ... import BP_BEFORE, BP_AFTER, SIM_LIBRARIES
...
class Tracer(Analysis):
    ...
    def __init__(self, input=None, pov_file=None, simprocedures=None, #pylint:disable=redefined-builtin
                 ...
                 dump_syscall=False, dump_cache=True, max_size=None,
                 exclude_sim_procedures_list=None, argv = None):
        """
