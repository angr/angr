...
from .rewriter_utils import CallRewriter, replace_argument_pairs


class ComboRegisterRewriter(OptimizationPass, SRDAMixin):
    """Rewrite return expressions for calls to functions returning several values via multiple registers."""
    ...
    def _check(self):
        return self.project.is_rust_binary or self.project.is_go_binary, None
