...
from angr.ailment.expression import BinaryOp, CallExpr, VirtualVariable, Const, Phi, Load, Expression
...
class InlinedStrlenSimplifier(OptimizationPass):
    ...
    def _convert_block_to_strlen(
        ...
        strlen_call = CallExpr(
            None, func_name, args=[str_expr], ret_expr=None, bits=result_var.bits, ins_addr=block.addr
        )
