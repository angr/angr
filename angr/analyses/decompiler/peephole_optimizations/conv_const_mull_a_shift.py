...
class ConvConstMullAShift(PeepholeOptimizationExprBase):
    ...
    def optimize(self, expr: Convert):
        ...
        if expr.from_bits == 64 and expr.to_bits == 32:
            if isinstance(expr.operand, BinaryOp) and expr.operand.op == "Shr" \
                ...
                if isinstance(inner, BinaryOp) and inner.op == "Mull" and isinstance(inner.operands[0], Const):
                    ...
                    if divisor is not None:
                        ...
                        new_expr = Convert(expr.idx, expr.from_bits, expr.to_bits, expr.is_signed,
                                           new_div, **expr.tags)
                        return new_expr
                ...
                if isinstance(expr0, BinaryOp) \
                    ...
                    if isinstance(expr0.operands[0], BinaryOp) \
