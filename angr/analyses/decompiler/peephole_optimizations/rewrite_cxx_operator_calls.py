...
from angr.ailment.statement import CallStmt, WeakAssignment
...
class RewriteCxxOperatorCalls(PeepholeOptimizationStmtBase):
    ...
    def optimize(self, stmt: CallStmt, block=None, **kwargs):  # type: ignore
    ...
    def _optimize_operator_equal(self, stmt: CallStmt) -> WeakAssignment | None:
    ...
    def _optimize_operator_add(self, stmt: CallStmt) -> WeakAssignment | None:
        if (
            stmt.args
            and len(stmt.args) == 3
