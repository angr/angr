...
class CTypeCast(CExpression):
    ...
    def c_repr_chunks(self, indent=0, asexpr=False):
        ...
        if self.codegen.show_casts:
            ...
            #     leading_paren = True
            #     yield "(", paren                       
            yield "{}".format("_".join((self.dst_type.c_repr(name=None).split(' ')))), self
            yield "(", paren    
