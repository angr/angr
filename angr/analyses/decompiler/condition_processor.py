...
_ail2claripy_op_mapping = {
    ...
    "CmpEQ": lambda expr, conv, _, ia, *args: (lambda a, b: a == b)(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpNE": lambda expr, conv, _, ia, *args: (lambda a, b: a != b)(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpLE": lambda expr, conv, _, ia, *args: (lambda a, b: a <= b)(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpLE (signed)": lambda expr, conv, _, ia, *args: (lambda a, b: claripy.SLE(a, b))(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpLT": lambda expr, conv, _, ia, *args: (lambda a, b: a < b)(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpLT (signed)": lambda expr, conv, _, ia, *args: (lambda a, b: claripy.SLT(a, b))(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpGE": lambda expr, conv, _, ia, *args: (lambda a, b: a >= b)(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpGE (signed)": lambda expr, conv, _, ia, *args: (lambda a, b: claripy.SGE(a, b))(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpGT": lambda expr, conv, _, ia, *args: (lambda a, b: a > b)(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CmpGT (signed)": lambda expr, conv, _, ia, *args: (lambda a, b: claripy.SGT(a, b))(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CasCmpEQ": lambda expr, conv, _, ia, *args: (lambda a, b: a == b)(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
    "CasCmpNE": lambda expr, conv, _, ia, *args: (lambda a, b: a != b)(
        *_align_widths(
            conv(expr.operands[0], nobool=True, ins_addr=ia), conv(expr.operands[1], nobool=True, ins_addr=ia)
        )
    ),
