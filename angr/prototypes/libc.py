...
for c_proto in _libc_prototypes:
    try:
        libc.add_c_proto(c_proto)
    except Exception:
        # Silently catch all parsing errors... supporting all libc function prototypes is impossible
        # TODO: Fix or comment out all function prototypes that lead to parsing errors
        pass
