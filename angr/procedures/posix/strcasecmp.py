...
import logging
l = logging.getLogger("angr.procedures.libc___so___6.strcasecmp")
...
class strcasecmp(angr.SimProcedure):
    ...
    def run(self, a_addr, b_addr):
        ...
        strncmp = self.inline_call(angr.SIM_PROCEDURES['libc.so.6']['strncmp'], a_addr, b_addr, maxlen, a_len=a_strlen, b_len=b_strlen)
