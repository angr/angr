...
class GetSystemTimeAsFileTime(angr.SimProcedure):
    ...
    def fill_symbolic(self):
        self.timestamp = claripy.BVS("SystemTimeAsFileTime", 64, key=("api", "SystemTimeAsFileTime"))
...
class GetLocalTime(angr.SimProcedure):
    ...
    def fill_symbolic(self):
        ...
        """
        self.wYear = claripy.BVS("cur_year", 16, key=("api", "GetLocalTime", "cur_year"))
        self.wMonth = claripy.BVS("cur_month", 16, key=("api", "GetLocalTime", "cur_month"))
        self.wDayOfWeek = claripy.BVS("cur_dayofweek", 16, key=("api", "GetLocalTime", "cur_dayofweek"))
        self.wDay = claripy.BVS("cur_day", 16, key=("api", "GetLocalTime", "cur_day"))
        self.wHour = claripy.BVS("cur_hour", 16, key=("api", "GetLocalTime", "cur_hour"))
        self.wMinute = claripy.BVS("cur_minute", 16, key=("api", "GetLocalTime", "cur_minute"))
        self.wSecond = claripy.BVS("cur_second", 16, key=("api", "GetLocalTime", "cur_second"))
        self.wMilliseconds = claripy.BVS("cur_millisecond", 16, key=("api", "GetLocalTime", "cur_millisecond"))
