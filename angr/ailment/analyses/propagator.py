...
from angr.engines.light import SimEngineLight, SimEngineLightVEXMixin, SimEngineLightAILMixin, SpOffset, RegisterOffset
...
class Propagator(ForwardAnalysis, Analysis):
    def __init__(self, func=None, block=None, max_iterations=3, stack_pointer_tracker=None):
        ...
        self._engine_vex = SimEnginePropagatorVEX(stack_pointer_tracker=self._stack_pointer_tracker)
