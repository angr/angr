...
# Terminate a block early as soon as we find a conditional branch that must be taken
# This *must not* be enabled for forced-concrete-execution based analyses or techniques, e.g., CFGAccurate
TERMINATE_EXEC_ON_FALSE_GUARD = "TERMINATE_EXEC_ON_FALSE_GUARD"
...
common_options = { DO_GETS, DO_PUTS, DO_LOADS, DO_OPS, COW_STATES, DO_STORES, OPTIMIZE_IR, TRACK_MEMORY_MAPPING, SUPPORT_FLOATING_POINT, EXTENDED_IROP_SUPPORT, ALL_FILES_EXIST, FILES_HAVE_EOF, TERMINATE_EXEC_ON_FALSE_GUARD } | simplification
...
modes = {
    ...
    'fastpath': (common_options - simplification - {TERMINATE_EXEC_ON_FALSE_GUARD} ) | (symbolic - { SYMBOLIC, DO_CCALLS }) | resilience | { TRACK_OP_ACTIONS, BEST_EFFORT_MEMORY_STORING, AVOID_MULTIVALUED_READS, AVOID_MULTIVALUED_WRITES, SYMBOLIC_INITIAL_VALUES, DO_RET_EMULATION, NO_SYMBOLIC_JUMP_RESOLUTION, NO_SYMBOLIC_SYSCALL_RESOLUTION, FAST_REGISTERS },
