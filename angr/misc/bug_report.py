...
def print_versions():
    ...
    for m in angr_modules:
        ...
        try:
            ...
            print("An error occurred importing {}: {}".format(m, e))
...
def print_git_info(dirname):
    ...
    print("Git info:")
    print("\tCurrent commit {} from branch {}".format(cur_commit.hexsha, cur_branch.name))
    try:
        ...
        if cur_tb.is_remote():
            ...
            print("\tChecked out from remote {}: {}".format(remote_name, remote_url))
        else:
