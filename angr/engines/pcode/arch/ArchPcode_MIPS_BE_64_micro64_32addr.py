...
class ArchPcode_MIPS_BE_64_micro64_32addr(ArchPcode):
    name = 'MIPS:BE:64:micro64-32addr'
    pcode_arch = 'MIPS:BE:64:micro64-32addr'
    description = 'MIPS64 32-bit addresses, big endian, with microMIPS'
    bits = 32
    ip_offset = 0x100
    sp_offset = 0xe8
    bp_offset = sp_offset
...
register_arch(['mips:be:64:micro64-32addr'], 32, Endness.BE, ArchPcode_MIPS_BE_64_micro64_32addr)
