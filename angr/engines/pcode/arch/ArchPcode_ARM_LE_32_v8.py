...
class ArchPcode_ARM_LE_32_v8(ArchPcode):
    name = 'ARM:LE:32:v8'
    pcode_arch = 'ARM:LE:32:v8'
    description = 'Generic ARM/Thumb v8 little endian'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
...
register_arch(['arm:le:32:v8'], 32, Endness.LE, ArchPcode_ARM_LE_32_v8)
