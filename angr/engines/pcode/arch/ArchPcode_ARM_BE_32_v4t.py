...
class ArchPcode_ARM_BE_32_v4t(ArchPcode):
    name = 'ARM:BE:32:v4t'
    pcode_arch = 'ARM:BE:32:v4t'
    description = 'Generic ARM/Thumb v4 big endian (T-variant)'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
...
register_arch(['arm:be:32:v4t'], 32, Endness.BE, ArchPcode_ARM_BE_32_v4t)
