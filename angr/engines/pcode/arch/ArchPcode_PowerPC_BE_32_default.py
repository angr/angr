...
class ArchPcode_PowerPC_BE_32_default(ArchPcode):
    name = 'PowerPC:BE:32:default'
    pcode_arch = 'PowerPC:BE:32:default'
    description = 'PowerPC 32-bit big endian w/Altivec, G2'
    bits = 32
    ip_offset = 0x780
    sp_offset = 0x4
    bp_offset = sp_offset
...
register_arch(['powerpc:be:32:default'], 32, Endness.BE, ArchPcode_PowerPC_BE_32_default)
