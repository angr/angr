...
class ArchPcode_MIPS_BE_32_default(ArchPcode):
    name = 'MIPS:BE:32:default'
    pcode_arch = 'MIPS:BE:32:default'
    description = 'MIPS32 32-bit addresses, big endian, with mips16e'
    bits = 32
    ip_offset = 0x80
    sp_offset = 0x74
    bp_offset = sp_offset
...
register_arch(['mips:be:32:default'], 32, Endness.BE, ArchPcode_MIPS_BE_32_default)
