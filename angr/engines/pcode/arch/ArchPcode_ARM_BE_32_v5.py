...
class ArchPcode_ARM_BE_32_v5(ArchPcode):
    name = 'ARM:BE:32:v5'
    pcode_arch = 'ARM:BE:32:v5'
    description = 'Generic ARM v5 big endian'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
...
register_arch(['arm:be:32:v5'], 32, Endness.BE, ArchPcode_ARM_BE_32_v5)
