...
class ArchPcode_tricore_LE_32_tc172x(ArchPcode):
    name = 'tricore:LE:32:tc172x'
    pcode_arch = 'tricore:LE:32:tc172x'
    description = 'Siemens Tricore Embedded Processor TC1724/TC1728'
    bits = 32
    ip_offset = 0xfe08
    sp_offset = 0xffa8
    bp_offset = sp_offset
...
register_arch(['tricore:le:32:tc172x'], 32, Endness.LE, ArchPcode_tricore_LE_32_tc172x)
