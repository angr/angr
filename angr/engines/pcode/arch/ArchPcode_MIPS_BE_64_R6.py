...
class ArchPcode_MIPS_BE_64_R6(ArchPcode):
    name = 'MIPS:BE:64:R6'
    pcode_arch = 'MIPS:BE:64:R6'
    description = 'MIPS64 Release-6 64-bit addresses, big endian, with microMIPS'
    bits = 64
    ip_offset = 0x100
    sp_offset = 0xe8
    bp_offset = sp_offset
...
register_arch(['mips:be:64:r6'], 64, Endness.BE, ArchPcode_MIPS_BE_64_R6)
