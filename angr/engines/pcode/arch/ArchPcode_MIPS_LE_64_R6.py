...
class ArchPcode_MIPS_LE_64_R6(ArchPcode):
    name = 'MIPS:LE:64:R6'
    pcode_arch = 'MIPS:LE:64:R6'
    description = 'MIPS64 Release-6 64-bit addresses, little endian, with microMIPS'
    bits = 64
    ip_offset = 0x100
    sp_offset = 0xe8
    bp_offset = sp_offset
...
register_arch(['mips:le:64:r6'], 64, Endness.LE, ArchPcode_MIPS_LE_64_R6)
