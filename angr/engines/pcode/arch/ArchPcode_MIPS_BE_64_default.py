...
class ArchPcode_MIPS_BE_64_default(ArchPcode):
    name = 'MIPS:BE:64:default'
    pcode_arch = 'MIPS:BE:64:default'
    description = 'MIPS64 64-bit addresses, big endian, with mips16e'
    bits = 64
    ip_offset = 0x100
    sp_offset = 0xe8
    bp_offset = sp_offset
...
register_arch(['mips:be:64:default'], 64, Endness.BE, ArchPcode_MIPS_BE_64_default)
