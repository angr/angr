...
class ArchPcode_PowerPC_LE_64_default(ArchPcode):
    name = 'PowerPC:LE:64:default'
    pcode_arch = 'PowerPC:LE:64:default'
    description = 'PowerPC 64-bit little endian w/Altivec, G2'
    bits = 64
    ip_offset = 0x780
    sp_offset = 0x8
    bp_offset = sp_offset
...
register_arch(['powerpc:le:64:default'], 64, Endness.LE, ArchPcode_PowerPC_LE_64_default)
