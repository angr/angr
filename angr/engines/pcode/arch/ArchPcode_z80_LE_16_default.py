...
class ArchPcode_z80_LE_16_default(ArchPcode):
    name = 'z80:LE:16:default'
    pcode_arch = 'z80:LE:16:default'
...
register_arch(['z80:le:16:default'], 16, Endness.LE, ArchPcode_z80_LE_16_default)
