...
class ArchPcode_ARM_BE_32_v7(ArchPcode):
    name = 'ARM:BE:32:v7'
    pcode_arch = 'ARM:BE:32:v7'
    description = 'Generic ARM/Thumb v7 big endian'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
...
register_arch(['arm:be:32:v7'], 32, Endness.BE, ArchPcode_ARM_BE_32_v7)
