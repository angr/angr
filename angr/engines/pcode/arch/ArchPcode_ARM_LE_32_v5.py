...
class ArchPcode_ARM_LE_32_v5(ArchPcode):
    name = 'ARM:LE:32:v5'
    pcode_arch = 'ARM:LE:32:v5'
    description = 'Generic ARM v5 little endian'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
...
register_arch(['arm:le:32:v5'], 32, Endness.LE, ArchPcode_ARM_LE_32_v5)
