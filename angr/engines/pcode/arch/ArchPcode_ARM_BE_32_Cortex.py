...
class ArchPcode_ARM_BE_32_Cortex(ArchPcode):
    name = 'ARM:BE:32:Cortex'
    pcode_arch = 'ARM:BE:32:Cortex'
    description = 'ARM Cortex / Thumb big endian'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
    ...
    register_list = [
        ...
        Register('q15', 16, 0x300),
        Register('d31', 8, 0x300),
        Register('s31', 4, 0x300),
        Register('s30', 4, 0x304),
        Register('d30', 8, 0x308),
        Register('s29', 4, 0x308),
        Register('s28', 4, 0x30c),
        Register('q14', 16, 0x310),
        Register('d29', 8, 0x310),
        Register('s27', 4, 0x310),
        Register('s26', 4, 0x314),
        Register('d28', 8, 0x318),
        Register('s25', 4, 0x318),
        Register('s24', 4, 0x31c),
        Register('q13', 16, 0x320),
        Register('d27', 8, 0x320),
        Register('s23', 4, 0x320),
        Register('s22', 4, 0x324),
        Register('d26', 8, 0x328),
        Register('s21', 4, 0x328),
        Register('s20', 4, 0x32c),
        Register('q12', 16, 0x330),
        Register('d25', 8, 0x330),
        Register('s19', 4, 0x330),
        Register('s18', 4, 0x334),
        Register('d24', 8, 0x338),
        Register('s17', 4, 0x338),
        Register('s16', 4, 0x33c),
        Register('q11', 16, 0x340),
        Register('d23', 8, 0x340),
        Register('s15', 4, 0x340),
        Register('s14', 4, 0x344),
        Register('d22', 8, 0x348),
        Register('s13', 4, 0x348),
        Register('s12', 4, 0x34c),
        Register('q10', 16, 0x350),
        Register('d21', 8, 0x350),
        Register('s11', 4, 0x350),
        Register('s10', 4, 0x354),
        Register('d20', 8, 0x358),
        Register('s9', 4, 0x358),
        Register('s8', 4, 0x35c),
        Register('q9', 16, 0x360),
        Register('d19', 8, 0x360),
        Register('s7', 4, 0x360),
        Register('s6', 4, 0x364),
        Register('d18', 8, 0x368),
        Register('s5', 4, 0x368),
        Register('s4', 4, 0x36c),
        Register('q8', 16, 0x370),
        Register('d17', 8, 0x370),
        Register('s3', 4, 0x370),
        Register('s2', 4, 0x374),
        Register('d16', 8, 0x378),
        Register('s1', 4, 0x378),
        Register('s0', 4, 0x37c),
...
register_arch(['arm:be:32:cortex'], 32, Endness.BE, ArchPcode_ARM_BE_32_Cortex)
