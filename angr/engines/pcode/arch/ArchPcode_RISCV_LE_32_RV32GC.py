...
class ArchPcode_RISCV_LE_32_RV32GC(ArchPcode):
    name = 'RISCV:LE:32:RV32GC'
    pcode_arch = 'RISCV:LE:32:RV32GC'
    description = 'RISC-V 32 little general purpose compressed'
    bits = 32
    ip_offset = 0x1000
    sp_offset = 0x2008
    bp_offset = sp_offset
...
register_arch(['riscv:le:32:rv32gc'], 32, Endness.LE, ArchPcode_RISCV_LE_32_RV32GC)
