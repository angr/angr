...
class ArchPcode_PowerPC_BE_64_default(ArchPcode):
    name = 'PowerPC:BE:64:default'
    pcode_arch = 'PowerPC:BE:64:default'
    description = 'PowerPC 64-bit big endian w/Altivec, G2'
    bits = 64
    ip_offset = 0x780
    sp_offset = 0x8
    bp_offset = sp_offset
...
register_arch(['powerpc:be:64:default'], 64, Endness.BE, ArchPcode_PowerPC_BE_64_default)
