...
class ArchPcode_PowerPC_LE_32_4xx(ArchPcode):
    name = 'PowerPC:LE:32:4xx'
    pcode_arch = 'PowerPC:LE:32:4xx'
    description = 'PowerPC 4xx 32-bit little endian embedded core'
    bits = 32
    ip_offset = 0x780
    sp_offset = 0x4
    bp_offset = sp_offset
...
register_arch(['powerpc:le:32:4xx'], 32, Endness.LE, ArchPcode_PowerPC_LE_32_4xx)
