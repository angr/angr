...
class ArchPcode_dsPIC33C_LE_24_default(ArchPcode):
    name = 'dsPIC33C:LE:24:default'
    pcode_arch = 'dsPIC33C:LE:24:default'
    description = 'dsPIC33C'
    bits = 24
    ip_offset = 0x2e
    sp_offset = 0x1e
    bp_offset = sp_offset
...
register_arch(['dspic33c:le:24:default'], 24, Endness.LE, ArchPcode_dsPIC33C_LE_24_default)
