...
class ArchPcode_ARM_BE_32_v5t(ArchPcode):
    name = 'ARM:BE:32:v5t'
    pcode_arch = 'ARM:BE:32:v5t'
    description = 'Generic ARM/Thumb v5 big endian (T-variant)'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
...
register_arch(['arm:be:32:v5t'], 32, Endness.BE, ArchPcode_ARM_BE_32_v5t)
