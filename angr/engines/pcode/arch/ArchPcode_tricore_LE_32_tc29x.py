...
class ArchPcode_tricore_LE_32_tc29x(ArchPcode):
    name = 'tricore:LE:32:tc29x'
    pcode_arch = 'tricore:LE:32:tc29x'
    description = 'Siemens Tricore Embedded Processor TC29x'
    bits = 32
    ip_offset = 0xfe08
    sp_offset = 0xffa8
    bp_offset = sp_offset
...
register_arch(['tricore:le:32:tc29x'], 32, Endness.LE, ArchPcode_tricore_LE_32_tc29x)
