...
class ArchPcode_Toy_BE_32_posStack(ArchPcode):
    name = 'Toy:BE:32:posStack'
    pcode_arch = 'Toy:BE:32:posStack'
    description = 'Toy (test) processor 32-bit big-endian'
    bits = 32
    ip_offset = 0x103c
    sp_offset = 0x1034
    bp_offset = sp_offset
...
register_arch(['toy:be:32:posstack'], 32, Endness.BE, ArchPcode_Toy_BE_32_posStack)
