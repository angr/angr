...
class ArchPcode_Toy_LE_32_builder_align2(ArchPcode):
    name = 'Toy:LE:32:builder.align2'
    pcode_arch = 'Toy:LE:32:builder.align2'
    description = 'Toy (test-builder) processor 32-bit little-endian word-aligned'
    bits = 32
    ip_offset = 0x103c
    sp_offset = 0x1034
    bp_offset = sp_offset
...
register_arch(['toy:le:32:builder.align2'], 32, Endness.LE, ArchPcode_Toy_LE_32_builder_align2)
