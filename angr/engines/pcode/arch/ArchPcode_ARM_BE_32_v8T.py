...
class ArchPcode_ARM_BE_32_v8T(ArchPcode):
    name = 'ARM:BE:32:v8T'
    pcode_arch = 'ARM:BE:32:v8T'
    description = 'Generic ARM/Thumb v8 big endian (Thumb is default)'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
...
register_arch(['arm:be:32:v8t'], 32, Endness.BE, ArchPcode_ARM_BE_32_v8T)
