...
class ArchPcode_RISCV_LE_64_default(ArchPcode):
    name = 'RISCV:LE:64:default'
    pcode_arch = 'RISCV:LE:64:default'
...
register_arch(['riscv:le:64:default'], 64, Endness.LE, ArchPcode_RISCV_LE_64_default)
