...
class ArchPcode_Toy_BE_32_default(ArchPcode):
    name = 'Toy:BE:32:default'
    pcode_arch = 'Toy:BE:32:default'
...
register_arch(['toy:be:32:default'], 32, Endness.BE, ArchPcode_Toy_BE_32_default)
