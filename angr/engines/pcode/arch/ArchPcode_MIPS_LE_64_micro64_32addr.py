...
class ArchPcode_MIPS_LE_64_micro64_32addr(ArchPcode):
    name = 'MIPS:LE:64:micro64-32addr'
    pcode_arch = 'MIPS:LE:64:micro64-32addr'
    description = 'MIPS64 32-bit addresses, little endian, with microMIPS'
    bits = 32
    ip_offset = 0x100
    sp_offset = 0xe8
    bp_offset = sp_offset
...
register_arch(['mips:le:64:micro64-32addr'], 32, Endness.LE, ArchPcode_MIPS_LE_64_micro64_32addr)
