...
class ArchPcode_MIPS_LE_32_R6(ArchPcode):
    name = 'MIPS:LE:32:R6'
    pcode_arch = 'MIPS:LE:32:R6'
    description = 'MIPS32 Release-6 32-bit addresses, little endian, with microMIPS'
    bits = 32
    ip_offset = 0x80
    sp_offset = 0x74
    bp_offset = sp_offset
...
register_arch(['mips:le:32:r6'], 32, Endness.LE, ArchPcode_MIPS_LE_32_R6)
