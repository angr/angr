...
class ArchPcode_ARM_LEBE_32_v8LEInstruction(ArchPcode):
    name = 'ARM:LEBE:32:v8LEInstruction'
    pcode_arch = 'ARM:LEBE:32:v8LEInstruction'
    description = 'Generic ARM/Thumb v8 little endian instructions and big endian data'
    bits = 32
    ip_offset = 0x5c
    sp_offset = 0x54
    bp_offset = sp_offset
...
register_arch(['arm:lebe:32:v8leinstruction'], 32, Endness.BE, ArchPcode_ARM_LEBE_32_v8LEInstruction)
