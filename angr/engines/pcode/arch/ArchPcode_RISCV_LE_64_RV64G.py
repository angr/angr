...
class ArchPcode_RISCV_LE_64_RV64G(ArchPcode):
    name = 'RISCV:LE:64:RV64G'
    pcode_arch = 'RISCV:LE:64:RV64G'
    description = 'RISC-V 64 little general purpose'
    bits = 64
    ip_offset = 0x1000
    sp_offset = 0x2010
    bp_offset = sp_offset
...
register_arch(['riscv:le:64:rv64g'], 64, Endness.LE, ArchPcode_RISCV_LE_64_RV64G)
