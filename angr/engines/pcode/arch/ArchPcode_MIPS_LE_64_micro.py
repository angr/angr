...
class ArchPcode_MIPS_LE_64_micro(ArchPcode):
    name = 'MIPS:LE:64:micro'
    pcode_arch = 'MIPS:LE:64:micro'
    description = 'MIPS64 64-bit addresses, little endian, with microMIPS'
    bits = 64
    ip_offset = 0x100
    sp_offset = 0xe8
    bp_offset = sp_offset
...
register_arch(['mips:le:64:micro'], 64, Endness.LE, ArchPcode_MIPS_LE_64_micro)
