...
class ArchPcode_PIC_24H_LE_24_default(ArchPcode):
    name = 'PIC-24H:LE:24:default'
    pcode_arch = 'PIC-24H:LE:24:default'
    description = 'PIC-24H'
    bits = 24
    ip_offset = 0x2e
    sp_offset = 0x1e
...
register_arch(['pic-24h:le:24:default'], 24, Endness.LE, ArchPcode_PIC_24H_LE_24_default)
