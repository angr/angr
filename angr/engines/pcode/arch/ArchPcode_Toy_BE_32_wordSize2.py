...
class ArchPcode_Toy_BE_32_wordSize2(ArchPcode):
    name = 'Toy:BE:32:wordSize2'
    pcode_arch = 'Toy:BE:32:wordSize2'
    description = 'Toy (test) processor 32-bit big-endian (wordsize=2)'
    bits = 32
    ip_offset = 0x103c
    sp_offset = 0x1034
    bp_offset = sp_offset
