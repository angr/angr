...
class ArchPcode_x86_LE_64_default(ArchPcode):
    name = 'x86:LE:64:default'
    pcode_arch = 'x86:LE:64:default'
    description = 'Intel/AMD 64-bit x86'
    bits = 64
    ip_offset = 0x288
    sp_offset = 0x20
    bp_offset = sp_offset
    ...
    register_list = [
        ...
        Register('r9b', 1, 0x88),
        Register('r10', 8, 0x90),
        Register('r10d', 4, 0x90),
        Register('r10w', 2, 0x90),
        Register('r10b', 1, 0x90),
        Register('r11', 8, 0x98),
        Register('r11d', 4, 0x98),
        Register('r11w', 2, 0x98),
        Register('r11b', 1, 0x98),
        Register('r12', 8, 0xa0),
        Register('r12d', 4, 0xa0),
        Register('r12w', 2, 0xa0),
        Register('r12b', 1, 0xa0),
        Register('r13', 8, 0xa8),
        Register('r13d', 4, 0xa8),
        Register('r13w', 2, 0xa8),
        Register('r13b', 1, 0xa8),
        Register('r14', 8, 0xb0),
        Register('r14d', 4, 0xb0),
        Register('r14w', 2, 0xb0),
        Register('r14b', 1, 0xb0),
        Register('r15', 8, 0xb8),
        Register('r15d', 4, 0xb8),
        Register('r15w', 2, 0xb8),
        Register('r15b', 1, 0xb8),
        Register('es', 2, 0x100),
        Register('cs', 2, 0x102),
        Register('ss', 2, 0x104),
        Register('ds', 2, 0x106),
        Register('fs', 2, 0x108),
        Register('gs', 2, 0x10a),
        Register('fs_offset', 8, 0x110),
        Register('gs_offset', 8, 0x118),
        Register('cf', 1, 0x200),
        Register('f1', 1, 0x201),
        Register('pf', 1, 0x202),
        Register('f3', 1, 0x203),
        ...
        Register('id', 1, 0x214),
        Register('rflags', 8, 0x280),
        Register('eflags', 4, 0x280),
        Register('flags', 2, 0x280),
        Register('rip', 8, 0x288, alias_names=('pc', 'ip')),
        Register('eip', 4, 0x288),
        Register('ip', 2, 0x288),
        Register('dr0', 8, 0x300),
        Register('dr1', 8, 0x308),
        Register('dr2', 8, 0x310),
        Register('dr3', 8, 0x318),
        Register('dr4', 8, 0x320),
        Register('dr5', 8, 0x328),
        Register('dr6', 8, 0x330),
        Register('dr7', 8, 0x338),
        Register('dr8', 8, 0x340),
        Register('dr9', 8, 0x348),
        Register('dr10', 8, 0x350),
        Register('dr11', 8, 0x358),
        Register('dr12', 8, 0x360),
        Register('dr13', 8, 0x368),
        Register('dr14', 8, 0x370),
        Register('dr15', 8, 0x378),
        Register('cr0', 8, 0x380),
        Register('cr1', 8, 0x388),
        Register('cr2', 8, 0x390),
        Register('cr3', 8, 0x398),
        Register('cr4', 8, 0x3a0),
        Register('cr5', 8, 0x3a8),
        Register('cr6', 8, 0x3b0),
        Register('cr7', 8, 0x3b8),
        Register('cr8', 8, 0x3c0),
        Register('cr9', 8, 0x3c8),
        Register('cr10', 8, 0x3d0),
        Register('cr11', 8, 0x3d8),
        Register('cr12', 8, 0x3e0),
        Register('cr13', 8, 0x3e8),
        Register('cr14', 8, 0x3f0),
        Register('cr15', 8, 0x3f8),
        ...
        Register('idtr', 12, 0x2200),
        Register('idtr_limit', 4, 0x2200),
        Register('idtr_address', 8, 0x2204),
        Register('gdtr', 12, 0x2220),
        Register('gdtr_limit', 4, 0x2220),
        Register('gdtr_address', 8, 0x2224),
        Register('ldtr', 14, 0x2240),
        Register('ldtr_limit', 4, 0x2240),
        Register('ldtr_address', 8, 0x2244),
        Register('ldtr_attributes', 2, 0x2248),
        Register('tr', 14, 0x2260),
        Register('tr_limit', 4, 0x2260),
        Register('tr_address', 8, 0x2264),
        Register('tr_attributes', 2, 0x2268)
    ]

register_arch(['x86:le:64:default'], 64, Endness.LE, ArchPcode_x86_LE_64_default)
