...
class ArchPcode_MIPS_BE_64_64_32R6addr(ArchPcode):
    name = 'MIPS:BE:64:64-32R6addr'
    pcode_arch = 'MIPS:BE:64:64-32R6addr'
    description = 'MIPS64 Release-6 big endian with 32 bit addressing and microMIPS'
    bits = 32
    ip_offset = 0x100
    sp_offset = 0xe8
    bp_offset = sp_offset
...
register_arch(['mips:be:64:64-32r6addr'], 32, Endness.BE, ArchPcode_MIPS_BE_64_64_32R6addr)
