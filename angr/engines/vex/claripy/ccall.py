...
def pc_actions_UMUL(state, nbits, cc_dep1, cc_dep2, cc_ndep, platform=None):
    lo_dep1 = cc_dep1[nbits - 1 : 0]
    lo_dep2 = cc_dep2[nbits - 1 : 0]
    ir = lo_dep1.zero_extend(nbits) * lo_dep2.zero_extend(nbits)
    lo = ir[nbits - 1 : 0]
...
def pc_actions_SMUL(state, nbits, cc_dep1, cc_dep2, cc_ndep, platform=None):
    lo_dep1 = cc_dep1[nbits - 1 : 0]
    lo_dep2 = cc_dep2[nbits - 1 : 0]
    ir = lo_dep1.sign_extend(nbits) * lo_dep2.sign_extend(nbits)
    hi = ir[2 * nbits - 1 : nbits]
    lo = ir[nbits - 1 : 0]
