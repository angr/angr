...
def setup_amd64():
    ...
    strncpy_verify_null_amd64 = angr.Project(test_location + "/strncpy_null/strncpy-verify-null-amd64", load_libs=True, default_analysis_mode='symbolic', use_sim_procedures=True, exclude_sim_procedures=['strncpy'])
