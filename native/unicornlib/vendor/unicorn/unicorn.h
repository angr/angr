...
*/
ANGR_UNICORN_API unsigned int (*uc_version)(unsigned int *major, unsigned int *minor);
...
*/
ANGR_UNICORN_API bool (*uc_arch_supported)(uc_arch arch);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_open)(uc_arch arch, uc_mode mode, uc_engine **uc);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_close)(uc_engine *uc);
...
*/
ANGR_UNICORN_API uc_err (*uc_query)(uc_engine *uc, uc_query_type type, size_t *result);
...
/*
 ...
 @return: error code of uc_err enum type (UC_ERR_*, see above)
*/
ANGR_UNICORN_API uc_err (*uc_ctl)(uc_engine *uc, uc_control_type control, ...);
...
/*
 ...
 @return: error code of uc_err enum type (UC_ERR_*, see above)
*/
ANGR_UNICORN_API uc_err (*uc_errno)(uc_engine *uc);
 ...
 */
ANGR_UNICORN_API const char *(*uc_strerror)(uc_err code);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_emu_start)(uc_engine *uc, uint64_t begin, uint64_t until,
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_emu_stop)(uc_engine *uc);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_hook_add)(uc_engine *uc, uc_hook *hh, int type, void *callback,
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_mem_regions)(uc_engine *uc, uc_mem_region **regions, uint32_t *count);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_context_alloc)(uc_engine *uc, uc_context **context);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_free)(void *mem);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_context_save)(uc_engine *uc, uc_context *context);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_context_restore)(uc_engine *uc, uc_context *context);
...
*/
ANGR_UNICORN_API size_t (*uc_context_size)(uc_engine *uc);
...
/*
  ...
  @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
ANGR_UNICORN_API uc_err (*uc_context_free)(uc_context *context);
